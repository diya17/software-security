...
public class UserContentProvider extends ContentProvider {
    private static final String AUTHORITY = "com.example.team28_cse551";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatcher.match(uri)) {
            case STUDENTS:
                delCount = db.delete(UserDatabase.TABLE, selection,
                        selectionArgs);
                break;
            case STUDENT:
                delCount = db.delete(UserDatabase.TABLE, selection,
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            case 1:
                cursor = db.query(UserDatabase.TABLE,
                        UserDatabase.ALL_COLUMNS, selection
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            case 1:
                updCount = db.update(UserDatabase.TABLE, values, selection,
                        selectionArgs);
                break;
            default:
                throw new IllegalArgumentException("This is an Unknown URI " +
